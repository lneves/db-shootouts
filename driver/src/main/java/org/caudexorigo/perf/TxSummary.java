...
public class TxSummary
{
	...
	protected TxSummary(String txName, double targetMixPct, long count, long minTs, long maxTs, long warningCount, long erroCount, double min, double max, double mean, double sum, double stdDev, TDigest histo)
	{
		super();
		this.txName = txName;
		this.targetMixPct = targetMixPct;
		this.count = count;
		this.minTs = minTs;
		this.maxTs = maxTs;
