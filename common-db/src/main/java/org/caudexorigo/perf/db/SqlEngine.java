...
public enum SqlEngine
{
	...
	public String getInfoQuery()
	{
		...
		{
			return "SELECT GROUP_CONCAT(variable_value SEPARATOR ', ') FROM information_schema.global_variables WHERE variable_name IN('version', 'version_compile_machine', 'version_compile_os');";
		}
		else if (this == ORACLE)
		{
